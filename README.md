...
User settings are stored in json/github.json and json/config.json:

github.json: stores your GitHub username

config.json: stores default project settings (e.g., default license)
